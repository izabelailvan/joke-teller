...
function tellMe(joke){
    VoiceRSS.speech({
        key: '00596e4b434d469386f724d2b5582a8c',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    ...
    try{
        ...
        if(data.setup){
            joke = `${data.setup} ... ${data.delivery}`; //add two strings
        } else {
            joke = data.joke;
        }
        // Text-to-Speach
...
// we dont want our button to be able to be pressed again until the joke is told => the button disabled when the audio is playing
